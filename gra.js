document.addEventListener('DOMContentLoaded', function() {
	...
	X.addEventListener("click", function() {
		...
		you_choose.innerText = "Wybrano krzyżyk \n \n Przeciwnik gra kółkiem";
		} else { 
		you_choose.innerText = "Wybrano krzyżyk";
		}
	...
	zero.addEventListener("click", function() {
		helper = "O";
		if (player == "human_play") { 
		document.getElementById("you_choose").innerText = "Wybrano kółko \n \n Przeciwnik gra krzyżykiem";
		} else { 
		document.getElementById("you_choose").innerText = "Wybrano kółko";
		}
	...
	reset_game.addEventListener("click", function() {
		for ( i = 0; i < all_td.length; i = i+1 ) {
			all_td[i].innerText = "";
			document.querySelector("#wynik").innerText = "Wynik gry:";
			helper = "O";
			player = "";
	...
	function computer_move() {
		...
		if (document.querySelector("#wynik").innerText.includes("Remis!")) { return;}
		let new_td = "";
		let new_td_tab = [];
	...
	{
		if (C === "X") {
		document.querySelector("#wynik").innerText = "Wygrana!" + " \n Wygrał gracz z krzyżykiem";			
		} else {
		document.querySelector("#wynik").innerText = "Wygrana!" + " \n Wygrał gracz z kółkiem";
		}
		winner = true;
	}
